...
public class PNGFilterLauncher {
  ...
  static void initializeFilters() {
    ...
    // Seria hacer los combos de filtros monocromaticos y los multicromaticos y despues hacer los metodos ?
    // Parece muy tosco
    // La forma en que funciona esto es metiendo los filtros en el pipeline pero si o si tengo que mapear los parametros ingresados e ir construyendo.
