...
2) No se aprovecha el estado/comportamiento comun.

Estos dos refactorings son practicamente "a la vez", separarlos lo veo innecesario.
- Extract Super Class --> Generalizar creando una Super Clase.
...
3) Metodo Sueldo() poco claro y con numeros magicos.

- Extract Method --> sueldo
...
4) Codigo repetido del metodo Sueldo()
